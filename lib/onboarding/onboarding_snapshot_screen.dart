                            ...
                            _animatedBlock(
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'You\'re now part of 1,000+ users reclaiming their focus',
                                    style: GoogleFonts.poppins(
                            ...
                            _animatedBlock(
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                      color: AppColors.gold(context).withOpacity(0.6),
                                      width: 1.5),
                                  boxShadow: [
                                    BoxShadow(
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          const SizedBox(height: 2),
                                          Text(
                                            '${widget.currentDailyHours.toStringAsFixed(1)}h',
                                            style: GoogleFonts.poppins(
                                              color: AppColors.gold(context),
                                              fontSize: 24,
                                              fontWeight: FontWeight.w800,
